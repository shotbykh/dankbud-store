            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        ...
                        <li><Link href="/checkout" className="hover:text-yellow-400 uppercase">Cart</Link></li>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm mb-4">
                        <li><Link href="/legal/terms" className="hover:text-yellow-400 uppercase text-xs">Terms of Service</Link></li>
                        <li><Link href="/legal/privacy" className="hover:text-yellow-400 uppercase text-xs">Privacy & POPIA</Link></li>
                        <li><Link href="/legal/refunds" className="hover:text-yellow-400 uppercase text-xs">Returns & Refunds</Link></li>
                    </ul>
